...
class CustomAuthManager {
  ...
  Future signOut() async {
    ...
    shopStateUAuthUserSubject.add(
      ShopStateUAuthUser(loggedIn: false),
    );
    persistAuthData();
  }

  Future<ShopStateUAuthUser?> signIn({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
  ...
  ShopStateUAuthUser? _updateCurrentUser({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
    ...
    final updatedUser = ShopStateUAuthUser(
      loggedIn: true,
      uid: authUid,
    );
    shopStateUAuthUserSubject.add(updatedUser);
    persistAuthData();
    return updatedUser;
  }
...
ShopStateUAuthUser? currentUser;
