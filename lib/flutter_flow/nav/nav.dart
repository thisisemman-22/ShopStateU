...
class AppStateNotifier extends ChangeNotifier {
  ...
  ShopStateUAuthUser? initialUser;
  ShopStateUAuthUser? user;
  ...
  void update(ShopStateUAuthUser newUser) {
    final shouldUpdate =
      ...
      routes: [
        ...
        FFRoute(
          ...
          builder: (context, params) => params.isEmpty
              ? NavBarPage(initialPage: 'CreateProduct')
              : CreateProductWidget(),
        ),
        FFRoute(
        ...
        FFRoute(
          name: SavedItemsWidget.routeName,
          path: SavedItemsWidget.routePath,
          requireAuth: true,
        ...
        FFRoute(
          name: SentMessagesWidget.routeName,
          path: SentMessagesWidget.routePath,
          requireAuth: true,
          builder: (context, params) => SentMessagesWidget(),
        ),
        FFRoute(
