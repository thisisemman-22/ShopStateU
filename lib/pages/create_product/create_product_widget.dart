                        ...
                        child: FFButtonWidget(
                          onPressed: () async {
                            ...
                            if (confirmDialogResponse) {
                              _model.addProductAPI = await AddProductCall.call(
                                productName:
                                ...
                                sellerName: FFAppState().persistFullName,
                                sellerCollege: FFAppState().persistCollege,
                              ...
                              if ((_model.addProductAPI?.succeeded ?? true)) {
                                await showDialog(
                                  context: context,
                                  builder: (alertDialogContext) {
                                    return AlertDialog(
