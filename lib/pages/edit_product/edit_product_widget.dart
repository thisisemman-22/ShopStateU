...
class _EditProductWidgetState extends State<EditProductWidget> {
  ...
  void initState() {
    ...
    _model.productNameTextController ??=
        TextEditingController(text: FFAppState().editName);
    _model.productNameFocusNode ??= FocusNode();

    _model.descriptionTextController ??=
        TextEditingController(text: FFAppState().editDescription);
    _model.descriptionFocusNode ??= FocusNode();

    _model.priceTextController ??=
        TextEditingController(text: FFAppState().editPrice.toString());
        ...
        appBar: AppBar(
          ...
          title: Column(
            ...
            children: [
              ...
              Text(
                'Fill out the information below to edit your product',
