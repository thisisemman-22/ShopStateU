...
class _InboxWidgetState extends State<InboxWidget> {
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      _model.getInboxAPI = await GetInboxMessagesCall.call(
        bearerToken: FFAppState().bearerToken,
        recepientName: FFAppState().persistFullName,
      );
        ...
        body: SafeArea(
          ...
          child: Column(
            ...
            children: [
              Align(
                ...
                child: Padding(
                  ...
                  child: InkWell(
                    ...
                    onTap: () async {
                      context.pushNamed(SentMessagesWidget.routeName);
                    },
                    child: Text(
                      'View sent messages',
              ...
              Builder(
                builder: (context) {
                  final senderNameChild = GetInboxMessagesCall.senderName(
                  ...
                  return RefreshIndicator(
                    ...
                    child: ListView.builder(
                      ...
                      itemBuilder: (context, senderNameChildIndex) {
                        final senderNameChildItem =
                            senderNameChild[senderNameChildIndex];
                        return Padding(
                                                      ...
                                                      valueOrDefault<String>(
                                                        GetInboxMessagesCall
                                                          ...
                                                          (_model.getInboxAPI
                                                            ...
                                                            senderNameChildIndex),
                                                        '[ERROR. This should contain message contents.]',
                                                      ),
                                                      textAlign:
                                                          TextAlign.start,
                                                      style:
