...
import 'saved_items_model.dart';
export 'saved_items_model.dart';

class SavedItemsWidget extends StatefulWidget {
  const SavedItemsWidget({super.key});

  static String routeName = 'savedItems';
  static String routePath = '/savedItems';
...
class _SavedItemsWidgetState extends State<SavedItemsWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SavedItemsModel());

    // On page load action.
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      _model.getSavedItemsAPI = await GetSavedItemsCall.call(
        ...
        body: Column(
          ...
          children: [
            Padding(
              ...
              child: Builder(
                builder: (context) {
                  final productIDChild = GetSavedItemsCall.savedProductId(
                                    ...
                                    children: [
                                      InkWell(
                                        ...
                                        child: ClipRRect(
                                          ...
                                          child: Image.network(
                                            (GetSavedItemsCall.savedImagePath(
                                          ...
                                          child: Container(
                                            ...
                                            child: Align(
                                              alignment: AlignmentDirectional(
                                                  0.0, 0.0),
                                              child: Text(
                                                'P${(GetSavedItemsCall.savedPrice(
                                                  (_model.getSavedItemsAPI
                                                          ?.jsonBody ??
                                                      ''),
                                            ...
                                            onTap: () async {
                                              ...
                                              var confirmDialogResponse =
                                                  await showDialog<bool>(
                                                      ...
                                                      false;
                                              _model.unsaveItemAPI =
                                                  await UnsaveAnItemCall.call(
                                                bearerToken:
                                                    FFAppState().bearerToken,
                                                productId: productIDChildItem,
                                              );

                                              _shouldSetState = true;
                                              if ((_model.unsaveItemAPI
                                                      ?.succeeded ??
                                                  true)) {
                                                await showDialog(
                                                  context: context,
