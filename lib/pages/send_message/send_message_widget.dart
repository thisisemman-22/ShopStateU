                  ...
                  child: FFButtonWidget(
                    onPressed: () async {
                      ...
                      if (confirmDialogResponse) {
                        _model.sendMessage = await SendAMessageCall.call(
                          recipientName: FFAppState().whomToSendName,
                          senderName: FFAppState().persistFullName,
                          messageContent: _model.messageTextController.text,
                          ...
                          await showDialog(
                            ...
                            builder: (alertDialogContext) {
                              return AlertDialog(
                                title: Text('Error'),
                                content:
                                    Text((_model.sendMessage?.bodyText ?? '')),
                                actions: [
                                  TextButton(
                                    onPressed: () =>
                                        Navigator.pop(alertDialogContext),
